...
export class BridgeController {
  ...
  async createMetadata(
    @Body() createBridge: CreateBridgeDto,
  ...
  async deleteOrdinal(
    ...
    console.log(id);
    const { id: userId } = await verifyAccessToken(accessToken).catch((e) => {
    ...
    const userOwner = await this.addressService.findUserByAddress(ownerNftIdAddress).catch((e) => {
      console.log(e);
