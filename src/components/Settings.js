...
function Settings({ setSettingsPopup }) {
    return (
        <div className='fixed top-0 right-0 z-30 h-screen w-screen flex items-center justify-center bg-gray-900 bg-opacity-50 select-none'>
            <div className="flex items-center justify-center text-gray-500 md:w-8/12 lg:w-6/12 xl:w-4/12">
                <div className="rounded-xl bg-white shadow-xl w-full p-5">
                    <h3 className="font-extrabold text-4xl text-primary-800 text-center mt-4">Settings</h3>
            ...
            <div className='h-screen w-screen absolute -z-10' onClick={() => setSettingsPopup(false)}></div>
        </div>
    )
}
